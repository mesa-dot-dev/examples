...
/**
 * Options parameter for the @see tinyVercelRepl function.
 */
export interface IVercelReplOptions {
...
class ShellState {
  ...
  private static async probeHome(sandbox: Sandbox): Promise<string> {
    ...
    return await result.output('both');
  }
 ...
 */
export default async function tinyVercelRepl(sandbox: Sandbox, options: IVercelReplOptions | undefined): Promise<void> {
