...
/**
 * Options parameter for the @see tinyE2bRepl function.
 */
export interface IE2bReplOptions {
 ...
 */
export default async function tinyE2bRepl(sandbox: Sandbox, options: IE2bReplOptions | undefined): Promise<void> {
